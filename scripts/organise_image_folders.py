...
old_dir = "/root/autodl-tmp/UAVDT/UAV-benchmark-M"
train_dir = "/root/autodl-fs/mydata/UAVDT/train/images"
val_dir = "/root/autodl-fs/mydata/UAVDT/val/images"
...
for folder in folder_names:
    folder_path = old_dir + '/' + folder + "/img1" # '../../UAV-benchmark-M/M0101'
    ...
    if folder in val_folds:
        for img_filename in img_filename_ls:
            ...
            old_img_path = old_dir + '/' + folder + '/img1/' + img_filename
