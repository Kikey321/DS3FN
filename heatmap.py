...
def get_params():
    params = {
        'weight': '/root/autodl-fs/yolov8-main/train/ASF-DySample-EMSC/weights/best.pt',
        'cfg': '/root/autodl-fs/yolov8-main/ultralytics/cfg/models/v8/yolov8-ASF-DySample-EMSC.yaml',
        'device': 'cuda:0',
